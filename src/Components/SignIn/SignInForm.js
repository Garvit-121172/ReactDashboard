...
function SignInForm() {
    ...
    return (
        <div className="signinform">
            ...
            <div className="rememberme"><input type="checkbox" style={{height:"15px",width:"15px",backgroundColor:"black"}} /><p style={{margin:"0",marginTop:"-2px"}}>Remember me</p></div>
            <button className="signin-btn">Sign In</button>
            <div className="forgot-div">
            <p style={{fontSize:"14px",margin:"0",color:"#626262",marginTop:"5px"}}>Forgot your password?</p>
            <p style={{fontSize:"14px",margin:"0",marginTop:"6px",color:"#ef4f23"}}>Create an account</p>
            </div>
            <TnC/>
