...
function SignUpForm() {
    ...
    return (
        <div className="signup-form">
            <button onClick={(e)=>alert("hi")} style={{backgroundColor:"white",cursor:"pointer",border:"2px solid #f6f6f6",borderRadius:"5px",marginBottom:"15px",height:"40px"}}><div  className="google-btn" ><img src={GLogo} alt="GLogo" height="20px"  width="20px" /><p style={{fontSize:"16px",margin:"0",paddingLeft:"10px"}} >Continue with Google</p></div></button>
            ...
            {err?<p style={{margin:"0",marginLeft:"0px",marginTop:"-5px",marginBottom:"12px",fontSize:"10px",fontStyle:"normal",color:"#FF0404",width:"120px",height:"19px",lineHeight:"19px"}}>*This Field is Required</p>
            :null }
            ...
            <p style={{color:"#B1B1B1",margin:"0",borderRight:"1px solid #B1B1B1",marginLeft:"0",marginRight:"0",paddingTop:"10px",flex:"0.1%",fontSize:"14px"}}>+91</p>
